  ...
  <?php include "navbar.html"; ?>
    <div class="container">
      <div class="starter-template">
      	<?php
        echo "<h1>Riding Lessons offered by MaryAnn Cash/Brown</h1>";
        echo "<hr>";
        echo "<h3>APHA, PHBA, PtHA, NSBA, IHBA, ARHA, ApHC, AHSA</h3>";
        echo "<ul class='list-unstyled'><li>Approved Judge</li><li>Riding Lessons</li><li>Horse Training</li></ul>";
     	?>
      </div>
    </div><!-- /.container -->
